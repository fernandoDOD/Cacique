	...
	<div class="row">
					...
					<div class="row">
						<div class="col-sm-6">
							...
							<div class="form-group">
		        				...
		        				<?php echo $form->textField($model,'descripcion',array('class'=>'form-control','maxlength'=>255,'placeholder'=>'Descripción')); ?>
							</div>
							<div class="form-group date js-my-datepicker">
		        				...
		        				<?php echo $form->textField($model,'fecha',array('class'=>'form-control','placeholder'=>'Desde','readonly'=>true,'data-date-format'=>"DD/MM/YYYY",'value'=>$fecha)); ?>
							</div>
							<div class="form-group date js-my-datepicker">
								<?php $fecha_fin = (!$model->fecha_fin == "")?(date_format(date_create($model->fecha_fin), 'd/m/Y')):(date('d/m/Y')); ?>
								<?php echo $form->labelEx($model,'fecha_fin'); ?>
		        				<?php echo $form->textField($model,'fecha_fin',array('class'=>'form-control','placeholder'=>'Hasta','readonly'=>true,'data-date-format'=>"DD/MM/YYYY",'value'=>$fecha_fin)); ?>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<div class="imag-before-upload" style="background-image: url(<?php echo Yii::app()->request->baseUrl; ?>/images/admin/gray.jpg); max-width: 360px;height: 300px;">
									<?php if(!$model->isNewRecord && $model->imagen != ""){ ?>
										<div class="img" style="background-image: url(<?php echo Yii::app()->request->baseUrl; ?>/images/convocations/400x400/<?php echo $model->imagen; ?>)"></div>
									<?php } ?>
								</div>
		...
		<div class="col-sm-12">
			<div class="form-group">
                ...
                <a href="<?php echo $this->createUrl('convocations/admin'); ?>" class="btn btn-danger">Cancelar</a>
			</div>
		</div>
	</div>
<?php $this->endWidget(); ?>