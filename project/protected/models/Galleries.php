...
class Galleries extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name', 'required'),
			array('save, status', 'numerical', 'integerOnly'=>true),
			array('name', 'length', 'max'=>150),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_gallery, name, save, status', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'images' => array(self::HAS_MANY, 'Images', 'gallery'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('save',$this->save);
